...
namespace CodeAcademyWeb
{
	public class Startup
	{
		...
		{
			services.AddDbContext<AcademyContext>(opt => opt.UseSqlServer("Server = localhost; User Id=sa; Password=<Sup3rm3gaeasi3ststrong3stpassword3ver>; Database = Academy", x => x.UseNodaTime())
